...
import { Globe, Layout, FilterX, Users, AlertTriangle, Calendar, ShieldCheck } from 'lucide-react';
                                    ...
                                    <div className="flex items-center justify-between mt-5 pt-4 border-t border-border/50">
                                        <div className="flex gap-2">
                                            <span className={`text-[9px] font-black px-2 py-0.5 rounded-md border shadow-sm transition-colors ${
                                                (domain.effective_status || domain.status)?.toLowerCase() === 'active' 
                                            ...
                                            <span className={`text-[9px] font-black px-2 py-0.5 rounded-md border shadow-sm transition-colors ${
                                                domain.payment_status?.toLowerCase() === 'paid' 
